...
export default function Error({
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[60vh] text-center p-6">
      ...
      <button
        onClick={() => reset()}
        className="bg-[var(--custom-bg-accent)] cursor-pointer text-[var(--custom-text-white)] hover:opacity-90 transition px-5 py-2 rounded-md shadow-sm"
      >
        <span className="flex items-center gap-2  text-[var(--custom-text-white)]">
