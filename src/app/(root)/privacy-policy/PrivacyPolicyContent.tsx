        ...
        <Card className="hover:scale-100 group py-0 mb-8" variant={"hoverEffect"} id="rights">
          <CardContent className="p-8">
            ...
            <div className="space-y-4">
              ...
              <ul className="list-disc pl-6 space-y-2">
                <li className="text-[var(--custom-text-primary)] dark:text(--custom-text-white)">Accessing or correcting your data</li>
                <li className="text-[var(--custom-text-primary)] dark:text(--custom-text-white)">Requesting deletion of your data</li>
                <li className="text-[var(--custom-text-primary)] dark:text(--custom-text-white)">Objecting to or restricting processing</li>
                <li className="text-[var(--custom-text-primary)] dark:text(--custom-text-white)">Withdrawing consent</li>
                <li className="text-[var(--custom-text-primary)] dark:text(--custom-text-white)">Lodging a complaint with authorities</li>
              </ul>
              <p className="text-[var(--custom-text-primary)] dark:text-[var(--custom-text-white)] text-base">
