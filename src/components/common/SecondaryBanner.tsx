        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center text-center p-6 z-1">
          ...
          {subtitle && (
            <div className="flex items-center gap-6 opacity-90 animate-in slide-in-from-bottom-4 duration-1000">
              <span className="h-[2px] w-8 md:w-24 bg-gradient-to-r from-transparent to-[var(--custom-bg-accent)] rounded-full"></span>
              <p className="text-[var(--custom-text-white)] text-xs md:text-xl font-bold uppercase tracking-[0.5em] drop-shadow-lg">
                {subtitle}
              </p>
              <span className="h-[2px] w-8 md:w-24 bg-gradient-to-l from-transparent to-[var(--custom-bg-accent)] rounded-full"></span>
            </div>
          )}
        </div>

        {/* Premium border shine effect at the bottom */}
        <div className="absolute bottom-0 inset-x-0 h-[1px] bg-gradient-to-r from-transparent via-[var(--custom-bg-accent)]/50 to-transparent" />
      </div>
    </section>
  );
};
