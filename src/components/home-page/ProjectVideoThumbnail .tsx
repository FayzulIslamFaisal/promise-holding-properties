...
//           <h1 className=" text-2xl md:text-3xl lg:text-5xl font-extrabold mb-10">Explore Our Promise Assets Projects</h1>
//         </div>
//         <div className="relative w-full h-[300px] md:h-[500px] shadow-2xl rounded-lg cursor-pointer border border-[var(--custom-border-primary)]" onClick={() => setOpen(true)}>
//           <Image
...
//           />
//           <div className="absolute inset-0 bg-[var(--custom-bg-accent)]/30 rounded-lg"></div>
//           <div className="absolute inset-0 flex items-center justify-center">
//             <div className="w-20 h-20 bg-[var(--custom-bg-accent)]/70 hover:bg-[var(--custom-bg-accent)] rounded-full flex items-center justify-center shadow-lg">
