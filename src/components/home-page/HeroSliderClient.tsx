...
export default function SuperFlowSlider({ banners }: HeroSliderProps) {
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 bg-[var(--brand-dark)]/20 z-1 dark:bg-primary/20 pointer-events-none" />
      ...
      <div className="absolute top-8 left-8 z-3">
        <Button
          ...
          className="bg-primary/40 hover:bg-primary/60 backdrop-blur-xl border-2 border-primary/20 hover:border-primary/40 text-white w-14 h-14 rounded-full cursor-pointer transition-all duration-500 hover:scale-110"
        >
      ...
      <div className="absolute bottom-0 left-0 w-full z-3">
        <div className="h-2 bg-black/20 backdrop-blur-sm overflow-hidden">
          <div
            className="h-full bg-gradient-to-r from-primary via-[var(--brand-dark)] to-white transition-all duration-100 ease-linear relative"
