        ...
        <div className="container mx-auto sectionSpaceBorder">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div className="col-span-1">
                    <p className="text-lg md:text-2xl  font-semibold text-[var(--brand-dark)] dark:text-white">Customer Information</p>
                    <div className="pt-4">
                ...
                <div className="col-span-1">
                    <p className="text-lg md:text-2xl  font-semibold text-[var(--brand-dark)] dark:text-white">Requirements</p>
                    <div className="pt-4">
                        <div className="relative">
                            <input
                            type="text"
