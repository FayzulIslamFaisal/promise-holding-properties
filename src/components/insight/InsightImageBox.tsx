...
const InsightImageBox = () => {
  return (
    <Card className="mb-8 group overflow-hidden py-0 rounded-lg p-4 md:p-6 bg-primaryAccent">
        <div className="w-full overflow-hidden h-[calc(100vh-100px)]  relative border border-[var(--brand-primary)]/40 shadow-xl group-hover:shadow-2xl rounded-lg transition-shadow duration-300">
            <Image
