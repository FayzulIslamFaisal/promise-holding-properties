        ...
        <div className="grid lg:grid-cols-2 gap-12 items-start">
          ...
          <div className="space-y-8">
            <div className={`transition-all duration-1000 ${isVisible ? 'animate-fade-in' : 'opacity-0'}`}>
              <h1 className="text-5xl lg:text-6xl font-normal bg-gradient-to-r from-[var(--custom-bg-primary)] via-[var(--custom-bg-secondary)] to-[var(--custom-bg-accent)] bg-clip-text text-transparent animate-gradient-shift bg-300% leading-tight">
                {projectData.title}
              </h1>
            </div>
            <div
            ...
            >
              {projectData.tags.map((tag, index) => (
                <Badge
                  key={tag}
                  variant="secondary"
                  className="px-4 py-2 bg-[var(--custom-bg-primary)]/75 backdrop-blur-sm border border-[var(--custom-border-primary)] text-[var(--custom-text-secondary)] hover:bg-[var(--custom-bg-accent)] hover:scale-105 transition-all duration-300 cursor-pointer hover:animate-bounce-micro"
            ...
            <Card className="bg-[var(--custom-bg-white)]/10 backdrop-blur-md border border-[var(--custom-border-primary)] overflow-hidden group hover:bg-[var(--custom-bg-white)/15] transition-all duration-500">
              <CardContent className="p-0 relative h-80">
                <div className="w-full h-full bg-gradient-to-br from-[var(--custom-bg-primary)]/20 to-[var(--custom-bg-accent)]/20 relative overflow-hidden group-hover:scale-105 transition-transform duration-700">
                  ...
                  {/* Shine Effect */}
                  <div className="absolute inset-0 bg-gradient-to-r from-transparent via-white/10 to-transparent transform -skew-x-12 group-hover:animate-glass-shine"></div>
                </div>
              </CardContent>
            </Card>
          </div>
