        ...
        <div className="grid lg:grid-cols-2 gap-12 items-start">
          ...
          <div className="space-y-8">
            <div className={`transition-all duration-1000 ${isVisible ? 'opacity-100' : 'opacity-0'}`}>
              <h1 className="text-5xl lg:text-6xl font-normal bg-gradient-to-r from-[var(--custom-bg-primary)] via-[var(--custom-bg-secondary)] to-[var(--custom-bg-accent)] bg-clip-text text-transparent bg-300% animate-gradient-shift leading-tight">
                {projectData.title}
              </h1>
            </div>
            ...
            <div className={`flex flex-wrap gap-3 transition-all duration-1000 delay-500 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
              {projectData.tags.map((tag) => (
                <Badge
                  key={tag}
                  variant="secondary"
                  className="px-4 py-2 bg-[var(--custom-bg-primary)]/75 backdrop-blur-sm border border-[var(--custom-border-primary)] text-[var(--custom-text-secondary)] hover:bg-[var(--custom-bg-accent)] hover:scale-105 transition-all duration-300 cursor-pointer"
                >
                  {tag}
                </Badge>
              ))}
