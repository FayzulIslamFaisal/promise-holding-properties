...
const JointVentureForm = () => {
  return (
    <section className="px-4">
        <div className="container mx-auto py-10 md:py-12  border-b border-primary/40">
            <div className="flex gap-8 lg:flex-row flex-col pb-6 md:pb-8">
                <h2 className="text-2xl flex-1 md:text-3xl lg:text-4xl font-bold capitalize dark:text-white text-[var(--brand-dark)]">
                    Start Your Joint <span className="text-primary">Venture Today</span> 
                </h2>
