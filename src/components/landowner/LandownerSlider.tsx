      ...
      <div className="relative w-full h-[450px] lg:h-[600px]">
        ...
        <div className="relative z-1 flex items-center justify-center h-full">
          <div className="w-full container mx-auto px-4">
            ...
            <div className="custom-prev absolute left-2 top-1/2 z-1 -translate-y-1/2 cursor-pointer bg-[var(--brand-dark)]/60 hover:bg-[var(--brand-dark)]/80 rounded-full p-2 backdrop-blur-md transition-all">
              <ChevronLeft color="white" />
            </div>
            <div className="custom-next absolute right-2 top-1/2 z-1 -translate-y-1/2 cursor-pointer bg-[var(--brand-dark)]/60 hover:bg-[var(--brand-dark)]/80 rounded-full p-2 backdrop-blur-md transition-all">
