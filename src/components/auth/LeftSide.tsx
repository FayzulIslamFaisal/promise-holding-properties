...
export default function LeftSide() {
  return (
    <div className="hidden lg:flex lg:w-1/2 relative">
      <div className="absolute inset-0 bg-gradient-to-br from-[var(--custom-bg-primary)]/20 via-[var(--custom-bg-primary)]/60 to-[var(--custom-bg-primary)]/40 z-1" />
      ...
      <div className="absolute bottom-8 left-8 z-2 text-[var(--custom-text-white)]">
