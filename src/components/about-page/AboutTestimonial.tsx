...
const AboutTestimonial = ({ autoplay = false }: { autoplay?: boolean }) => {
      ...
      <div className="container mx-auto antialiased sectionSpaceBorder">
        <div className="mb-8 md:mb-14">
          <motion.h2 
            ...
            className="text-3xl sm:text-4xl md:text-5xl text-center font-bold capitalize darkLight-text-color relative"
          >
            testimonials
          </motion.h2>
        </div>
        ...
        <div className="relative grid grid-cols-1 gap-12 md:grid-cols-2 h-full pb-0 md:pb-10">
          ...
          <div className="flex flex-col justify-between">
            ...
            >
              <motion.div 
                className="text-6xl darkLight-text-color font-serif mb-0 pb-0"
                initial={{ scale: 0 }}
                animate={{ scale: 1 }}
              ...
              <motion.p 
                className="text-lg leading-relaxed darkLight-text-color"
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
              ...
              <div className="space-y-2">
                <motion.h3 
                  className="text-2xl font-bold darkLight-text-color"
