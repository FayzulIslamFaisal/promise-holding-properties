...
const Card = ({
  ...
  return (
    <div
      className={cn(
        "rounded-2xl h-full w-full p-6 overflow-hidden bg-[var(--brand-dark)]/5 dark:bg-white/5 border border-primary/20 group-hover:border-primary/70 shadow-sm group-hover:shadow-lg transition-all duration-300 relative z-0",
        className,
      )}
    >
...
const CardTitle = ({
  ...
  return <h4 className={cn("bg-primary/10 text-primary p-3 rounded-full mb-3", className)}>{children}</h4>
}
